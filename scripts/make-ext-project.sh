...
-DGEOC_INCLUDE_DIRS=$INSTALL_PATH/include -DCMAKE_PREFIX_PATH=/home-local/dantu1/Documents/local_libs/lib
make
make install
...
-DSCABOLIC_LIBS_DIR=$INSTALL_PATH/lib -DCMAKE_PREFIX_PATH=/home-local/dantu1/Documents/local_libs/lib
make
make install
