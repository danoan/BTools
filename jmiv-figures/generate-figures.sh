...
${SCRIPT_FOLDER}/fig11-12/jmiv-fig11-12.sh ${BTOOLS_BIN} ${EXT_BIN}
echo "Generating JMIV figure 13"
${SCRIPT_FOLDER}/fig13/jmiv-fig13.sh ${BTOOLS_BIN} ${EXT_BIN}
echo "Generating JMIV figure 14-15"
${SCRIPT_FOLDER}/fig14-15/jmiv-fig14-15.sh ${BTOOLS_BIN} ${EXT_BIN}