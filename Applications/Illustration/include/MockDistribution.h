#ifndef BTOOLS_APPLICATION_ILLUSTRATION_MOCKDISTRIBUTION_H
#define BTOOLS_APPLICATION_ILLUSTRATION_MOCKDISTRIBUTION_H
...
#endif //BTOOLS_APPLICATION_ILLUSTRATION_MOCKDISTRIBUTION_H
