#ifndef BTOOLS_APPLICATION_FROMSEED_FROMSEEDCONTROL_H
#define BTOOLS_APPLICATION_FROMSEED_FROMSEEDCONTROL_H
...
#endif //BTOOLS_APPLICATION_FROMSEED_FROMSEEDCONTROL_H
